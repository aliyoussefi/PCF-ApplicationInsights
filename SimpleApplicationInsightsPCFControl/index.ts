...
export class SimpleApplicationInsightsPCFControl implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	private responseText: HTMLLabelElement;
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement)
	{
		...
		var telemetryInitializer = (envelope) => {
			...
			envelope.tags["ai.operation.name"] = SimpleApplicationInsightsPCFControl.name;
		...
		this._container.appendChild(this.responseText);
